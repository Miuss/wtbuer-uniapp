<template>
	<div>
		...
		<div class="ical-info-card">
			什么是iCal？<br/>
			iCal日历是苹果系统自带的日历App，我们小程序系统为您提供一个Url链接，您可以通过ios日历软件添加订阅日历，然后将您的每学期的课表插入到系统日历中。<br/>
			订阅教程？<br/>
			玩苹果手机的应去日历系统研究研究吧。导入后还是很方便的。<br/>
			注意：我们暂时不能确定苹果日历是否会自动去更新订阅的课表数据，建议定期或者老师通知更新课表后更新您的订阅链接。
		</div>
	</div>
</template>
